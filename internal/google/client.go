...
func NewClient(ctx context.Context, adminEmail string, googleCredentialsJson []byte) (Client, error) {
	config, err := google.JWTConfigFromJSON(googleCredentialsJson, admin.AdminDirectoryGroupReadonlyScope,
